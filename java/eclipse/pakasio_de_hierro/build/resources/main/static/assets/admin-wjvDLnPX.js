import{n as d}from"./navbar-app-DRu8yxQW.js";import{d as i}from"./domainName-BqwKdE-m.js";const m=async e=>(await(await fetch(e)).json()).map(({firstName:r,lastName:n,avatar:a,serialNumber:c,email:l})=>`
