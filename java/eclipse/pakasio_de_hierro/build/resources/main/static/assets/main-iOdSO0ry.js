import{n as d}from"./navbar-app-DRu8yxQW.js";import{d as n}from"./domainName-BqwKdE-m.js";const i=async t=>{const s=await fetch(t);if(s.status!==200)throw(await s.json()).message;return(await s.json())._embedded.products.map(({name:e,image:a,price:c})=>`
